                                ...
                                <div class="folder-actions">
                                    ...
                                    <div class="folder-dropdown" id="dropdown-fav-${folder.id}">
                                        <div class="folder-dropdown-item" data-action="remove-favorite">
                                            <span class="folder-dropdown-icon">⭐</span>
                                            <span>Remove from Favorites</span>
                                        </div>
                                        <div class="folder-dropdown-item" data-action="rename">
                                            <span class="folder-dropdown-icon">✏️</span>
                                            <span>Rename</span>
                                        </div>
    ...
    <div class="content">${note.content}</div>
            ...
            setupEventListeners() {
                ...
                tagInput.addEventListener('input', (e) => {
                    ...
                    // Get all existing tags that match and aren't already on this note
                ...
                document.addEventListener('mouseup', (e) => {
                    setTimeout(() => {
                        ...
                        if (text.length > 0 && editor.contains(selection.anchorNode)) {
                            ...
                            try {
                                startRange.setStart(currentRange.startContainer, currentRange.startOffset);
                            ...
                            // Position: directly above the selection start, aligned left
                            let left = startRect.left - contentRect.left;
                            let top = startRect.top - contentRect.top - toolbarRect.height - 8;

                            // Ensure toolbar stays within editor-content bounds
                            const maxLeft = contentRect.width - toolbarRect.width - 16;
                            left = Math.max(8, Math.min(left, maxLeft));

                            // If too close to top, show below the selection
                            if (top < 0) {
                                top = startRect.bottom - contentRect.top + 8;
                            }
